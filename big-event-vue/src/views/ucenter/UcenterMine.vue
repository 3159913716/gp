    ...
    <!-- 我的管理组件 -->
      <div class="ucenter-mine">
        ...
        <div class="list-first">
          <router-link to="/admin/ucenter/mine/collect">文章收藏</router-link>                   
          <router-link to="/admin/ucenter/mine/follow">用户关注</router-link>
          <router-link to="/admin/ucenter/mine/fans">我的米线</router-link>
        </div>
